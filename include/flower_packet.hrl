...
-type ofp_error_type() :: 'hello_failed' | 'bad_request' |
                          'bad_action' | 'flow_mod_failed' |
...
-type ofp_port_name() :: 'in_port' | 'table' | 'normal' | 'flood' | 'all' |
                         'controller' | 'local' | 'none'.
-type ofp_port() :: ofp_port_name() | ofp_port_number().
-type ofp_group() :: 0..16#ffffffff.
-type ofp_command() :: 'hello' | 'error' | 'echo_request' | 'echo_reply' |
                       'vendor' | 'features_request' | 'features_reply' |
                       'get_config_request' | 'get_config_reply' |
                       'set_config' | 'packet_in' | 'flow_removed' |
                       'port_status' |
                       'packet_out' | 'flow_mod' | 'port_mod' | 'stats_request'
                     | 'stats_reply' | 'barrier_request' |
...
-type ofp_capabilities() :: 'flow_stats' | 'table_stats' | 'port_stats' |
                            'stp' | 'reserved' | 'ip_reasm' | 'queue_stats' |
                            'arp_match_ip'.
-type ofp_action_type() :: 'output' | 'set_vlan_vid' | 'set_vlan_pcp' |
                           'strip_vlan' | 'set_dl_src' | 'set_dl_dst' |
                           'set_nw_src' | 'set_nw_dst' | 'set_nw_tos' |
                           'set_tp_src' | 'set_tp_dst' | 'enqueue'.
-type ofp_port_config() :: 'port_down' | 'no_stp' | 'no_recv' | 'no_recv_stp' |
                           'no_flood' | 'no_fwd' | 'no_packet_in'.
-type ofp_port_state() :: 'link_down' | 'stp_listen' | 'stp_learn' |
                          'stp_forward' | 'stp_block'.
-type ofp_port_features() :: '10mb_hd' | '10mb_fd' | '100mb_hd' | '100mb_fd' |
                             '1gb_hd' | '1gb_fd' | '10gb_fd'
                           | 'copper' | 'fiber' | 'autoneg' | 'pause' |
                             'pause_asym'.
-type ofp_config_flags() :: 'frag_normal' | 'frag_drop' | 'frag_reasm' |
                            'frag_mask'.
-type ofp_packet_in_reason() ::'no_match' | 'action'.
-type ofp_match_type() :: 'standard'.
-type ofp_instruction_type() :: 'goto_table' | 'write_metadata' |
...
-type nxm_header() :: 'nxm_of_in_port' | 'nxm_of_eth_dst' | 'nxm_of_eth_dst_w' |
                      ...
                      'nxm_of_vlan_tci_w' | 'nxm_of_ip_tos' |
                      'nxm_of_ip_proto' |
                      ...
                      'nxm_of_arp_spa_w' | 'nxm_of_arp_tpa' |
                      'nxm_of_arp_tpa_w' |
                      'nxm_nx_tun_id' | 'nxm_nx_tun_id_w' | 'nxm_nx_arp_sha' |
                      'nxm_nx_arp_tha' | 'nxm_nx_ipv6_src' |
                      'nxm_nx_ipv6_src_w' |
                      'nxm_nx_ipv6_dst' | 'nxm_nx_ipv6_dst_w' |
                      'nxm_nx_icmpv6_type' |
                      'nxm_nx_icmpv6_code' | 'nxm_nx_nd_target' |
                      'nxm_nx_nd_sll' |
                      'nxm_nx_nd_tll' | nxm_reg().
-type nxt_action() :: 'nxast_snat__obsolete' | 'nxast_resubmit' |
                      'nxast_set_tunnel' |
...
-type of_vendor_ext() :: 'nxt_role_request' | 'nxt_role_reply' |
                         'nxt_set_flow_format' | 'nxt_flow_mod' |
                         'nxt_flow_removed' | 'nxt_flow_mod_table_id'.
-type of_experimenter_ext() :: 'rofl_none' | 'rofl_flowspace' | binary().

-type oxm_tlv_type() :: 'in_port' | 'in_phy_port' | 'metadata' | 'eth_dst' |
                        'eth_src' | 'eth_type' | 'vlan_vid' | 'vlan_vid' |
                        'vlan_vid' | 'vlan_pcp' | 'ip_dscp' | 'ip_ecn' |
                        'ip_proto' | 'ipv4_src' | 'ipv4_dst' |
                        'tcp_src' | 'tcp_dst' | 'udp_src' | 'udp_dst' |
                        'sctp_src' | 'sctp_dst' | 'icmpv4_type' |
                        'icmpv4_code' | 'arp_op' | 'arp_spa' |
                        'arp_tpa' | 'arp_sha' | 'arp_tha' | 'ipv6_src' |
                        'ipv6_dst' | 'ipv6_flabel' | 'icmpv6_type' |
                        'icmpv6_code' | 'ipv6_nd_target' |
                        'ipv6_nd_sll' | 'ipv6_nd_tll' | 'mpls_flabel' |
                        'mpls_tc' |
...
-record(ofp_error, {
          ...
          data          :: binary()       %% Variable-length data.
                           %% Interpreted based
...
-record(ofp_phy_port, {
          port_no = none        :: ofp_port(),
          %% A value the datapath associates with a physical port.
          hw_addr = <<0:48>>    :: <<_:48>>,
          %% Typically The MAC address for the port
          name = <<>>           :: binary(),
          ...
          %% Current port bitrate in kbps. (OF 1.1)
          max_speed = 0         :: integer()
          %% Max port bitrate in kbps. (OF 1.1)
                                   }).

%% Switch features
-record(ofp_switch_features, {
          datapath_id = 0       :: non_neg_integer(),
          ...
          n_buffers = 0         :: non_neg_integer(),
          %% Max packets buffered at once.
          n_tables = 0          :: non_neg_integer(),
          %% Number of tables supported by datapath.


          %% Features:
          capabilities = []     :: [ofp_capabilities()],
          %%   List of supported "ofp_capabilities".
          actions = []          :: [ofp_action_type()],
          %%   List of supported "ofp_action_type"s.
...
-record(ofp_packet_in, {
          ...
          data = <<>>           :: binary()
          %% Ethernet frame, halfway through 32-bit
          %% word, so the IP header is 32-bit aligned.
                                   }).
...
-record(ofp_packet_in_v11, {
          ...
          in_port = none        :: ofp_port(),
          %% Port on which frame was received.
          in_phy_port = none    :: ofp_port(),
          %% Physical Port on which frame was received.
          total_len = 0         :: non_neg_integer(),
          %% Full length of frame.
          reason                :: ofp_packet_in_reason(),
          %% Reason packet is being sent
          table_id = 0          :: non_neg_integer(),
...
-record(ofp_switch_config, {
          flags = frag_normal           :: ofp_config_flags(),
          %% The configuration flags
          miss_send_len = 0             :: non_neg_integer()
          %% Max bytes of new flow that
          %% datapath should
...
-record(ofp_match_standard, {
          ...
          dl_src = <<0,0,0,0,0,0>>              :: <<_:48>>,
          %% Ethernet source address.
          dl_src_mask = <<0,0,0,0,0,0>>         :: <<_:48>>,
          %% Ethernet source address mask. (OF 1.1)
          dl_dst = <<0,0,0,0,0,0>>              :: <<_:48>>,
          %% Ethernet destination address.
          dl_dst_mask = <<0,0,0,0,0,0>>         :: <<_:48>>,
          %% Ethernet destination address mask. (OF 1.1)
          dl_vlan = 0                           :: non_neg_integer(),
          %% Input VLAN id.
          dl_vlan_pcp = 0                       :: non_neg_integer(),
          %% Input VLAN priority.
          ...
          nw_src = <<0,0,0,0>>                  :: <<_:32>>,
          %% IP source address.
          nw_src_mask = <<0,0,0,0>>             :: <<_:32>>,
          %% IP source address mask. (OF 1.1)
          nw_dst = <<0,0,0,0>>                  :: <<_:32>>,
          %% IP destination address.
          nw_dst_mask = <<0,0,0,0>>             :: <<_:32>>,
          %% IP destination address mask. (OF 1.1)
          tp_src = 0                            :: non_neg_integer(),
          %% TCP/UDP source port.
          tp_dst = 0                            :: non_neg_integer(),
          %% TCP/UDP destination port.
          mpls_label = 0                        :: non_neg_integer(),
          %% MPLS label. (OF 1.1)
          mpls_tc = 0                           :: non_neg_integer(),
          %% MPLS TC. (OF 1.1)
          metadata = <<0,0,0,0,0,0,0,0>>        :: <<_:64>>,
          %% Metadata passed between tables. (OF 1.1)
          metadata_mask = <<0,0,0,0,0,0,0,0>>   :: <<_:64>>
          %% Mask for metadata. (OF 1.1)
                                                   }).
...
-record(ofp_action_enqueue, {
          port = none           :: ofp_port(),
          %% Port that queue belongs. Should refer to a valid physical port
...
-type ofp_action() :: #ofp_action_output{} | #ofp_action_enqueue{} |
                      #ofp_action_vlan_vid{} | #ofp_action_vlan_pcp{} |
                      #ofp_action_strip_vlan{} | #ofp_action_dl_addr{} |
...
-type ofp_action_v11() :: #ofp_action_output{} | #ofp_action_vlan_vid{} |
                          #ofp_action_vlan_pcp{} | #ofp_action_strip_vlan{} |
                          #ofp_action_dl_addr{} | #ofp_action_nw_addr{} |
                          #ofp_action_nw_tos{} | #ofp_action_set_nw_ecn{} |
                          #ofp_action_tp_port{} | #ofp_action_copy_ttl_out{} |
                          #ofp_action_copy_ttl_in{} |
                          #ofp_action_set_mpls_label{} |
                          #ofp_action_set_mpls_tc{} |
                          #ofp_action_set_mpls_ttl{} |
                          #ofp_action_dec_mpls_ttl{} |
                          #ofp_action_push_vlan{} | #ofp_action_pop_vlan{} |
                          #ofp_action_push_mpls{} | #ofp_action_pop_mpls{} |
                          #ofp_action_set_queue{} |
                          #ofp_action_group{} | #ofp_action_set_nw_ttl{} |
                          #ofp_action_dec_nw_ttl{} |
                          #ofp_action_experimenter{}.

-type ofp_actions_v11() :: [ofp_action_v11() | binary()] | ofp_action_v11() |
                           binary().

%% Setup the next table in the lookup pipeline
-record(ofp_instruction_goto_table, {
          table_id = 0          :: ofp_table_id()
...
-record(ofp_instruction_actions, {
          type :: 'write_actions' | 'apply_actions' | 'clear_actions',
          %% One of OFPIT_*_ACTIONS
          actions = [] :: ofp_actions_v11()
...
-type ofp_instructions() :: [ofp_instruction() | binary()] |
                            ofp_instruction() | binary().

%% Flow setup and teardown (controller -> datapath).
-record(ofp_flow_mod, {
          match                 :: binary() | #ofp_match{},
          %% Fields to match
          cookie = 0            :: non_neg_integer(),
          ...
          buffer_id = ?OFP_NO_BUFFER    :: integer(),
...
-record(ofp_bucket, {
          ...
          watch_port = none       :: ofp_port(),
          %% Port whose state affects whether this

          %% bucket is live. Only required for fast

          %% failover groups.
          watch_group = 0         :: uint32(),
...
-record(ofp_group_mod, {
          ...
          %% Group identifier.
          buckets = []            :: ofp_buckets()
          %% The bucket length is inferred from the
...
-record(ofp_port_mod, {
          ...
          %% ofp_phy_port record.
          config = []           :: [ofp_port_config()],
          %% List of "ofp_port_config" to set.
          mask = []             :: [ofp_port_config()],
          %% List of "ofp_port_config" flags to be changed.
          advertise = []        :: [ofp_port_features()]
          %% List of "ofp_port_features"s. Leave empty
...
-record(ofp_table_mod, {
          table_id :: integer(),
          %% ID of the table, 0xFF indicates all tables
...
-record(ofp_flow_removed, {
          ...
          reason                :: ofp_reason(),
          %% Reason
          duration              :: ofp_duration(),
          %% Time flow was alive in seconds,nanoseconds.
...
-record(ofp_flow_stats, {
          ...
          %% Description of fields.
          duration      :: ofp_duration(),
          %% Time flow has been alive in {seconds, nanoseconds}
...
-record(ofp_table_stats_v11, {
          ...
          name          :: binary(),
          wildcards     :: uint32(),
          %% Bitmap of OFPFMF_* wildcards that are
          %% supported by the table.
          match         :: uint32(),
          %% Bitmap of OFPFMF_* that indicate the fields
          %% the table can match on.
          instructions  :: uint32(),
          %% Bitmap of OFPIT_* values supported.
          write_actions :: uint32(),
          %% Bitmap of OFPAT_* that are supported
...
-record(ofp_table_stats_v12, {
          ...
          name                  :: binary(),
          match                 :: uint64(),
          %% Bitmap of OFPXMT_* that indicate the fields
          %% the table can match on.
          wildcards             :: uint64(),
          %% Bitmap of OFPXMT_* wildcards that are
          %% supported by the table.
          write_actions         :: uint32(),
          %% Bitmap of OFPAT_* that are supported
          %% by the table with OFPIT_WRITE_ACTIONS.
          ...
          %% Bitmap of (1 << OFPXMT_*) header fields that
...
-record(rofl_flowspace, {
          action        :: 'add' | 'del',
          %% Add or Delete FlowSpace registration
          match         :: binary() | #ofp_match{}
          %% Fields to match.
                           }).
